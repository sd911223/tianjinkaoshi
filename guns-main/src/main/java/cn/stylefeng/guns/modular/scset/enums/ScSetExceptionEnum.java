package cn.stylefeng.guns.modular.scset.enums;
...
public enum ScSetExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    ScSetExceptionEnum(int code, String message) {
        this.code = code;
