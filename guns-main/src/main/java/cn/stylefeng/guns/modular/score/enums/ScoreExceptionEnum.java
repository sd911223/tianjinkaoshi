package cn.stylefeng.guns.modular.score.enums;
...
public enum ScoreExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    ScoreExceptionEnum(int code, String message) {
        this.code = code;
