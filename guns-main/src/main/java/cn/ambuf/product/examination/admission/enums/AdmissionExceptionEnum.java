package cn.ambuf.product.examination.admission.enums;
...
public enum AdmissionExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    AdmissionExceptionEnum(int code, String message) {
        this.code = code;
