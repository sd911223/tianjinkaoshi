...
<!-- saved from url=(0064)http://www.tjwsrc.com/master_ecc_form.asp?Pno=330724199204175432 -->
...
<div class="noprint">
    <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" class="common" style="border:none">
        <form id="form1" name="form1" method="post" action="http://www.tjwsrc.com/mypdf.aspx" target="_blank"></form>
        <tbody>
        <tr>
            <td height="30" align="center" valign="middle" style="border:none">
                <a class="layui-btn" href="http://127.0.0.1:8080/master_ECC_down.asp?pno=330724199204175432">下载PDF表</a>
                <a class="layui-btn" href="http://www.tjwsrc.com/master_ecc_form.asp?Pno=330724199204175432#"
...
<div id="div1">
    <table width="692" border="0" align="center" cellpadding="0" cellspacing="0" style="border:none">
        <tbody>
        <tr>
            <td height="90" align="center" class="FormTitle" style="border:none">2020年传统医学师承出师考核综合笔试准考证</td>
        </tr>
        </tbody>
    </table>
    <table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
        <tbody>
        <tr>
            <td width="279" height="42" align="center" class="NText">
                <strong>姓
                    <strong>
                        <strong>&nbsp;&nbsp;&nbsp;&nbsp;</strong></strong>名</strong>
            </td>
            <td width="279" align="center" class="NText">
                <strong>准考证号</strong></td>
            <td width="130" rowspan="4" align="center" valign="middle">
                <img src="sc/files/HY_2020050611272897550.jpg" width="120" height="140" style="padding-top:0px;"></img></td>
        </tr>
        <tr>
            <td height="42" align="center" class="NText">朱厚学</td>
            <td align="center" class="NText">2020080051</td>
        </tr>
        <tr>
            <td height="42" colspan="2" align="left" class="NNText">
                <strong>有效证明身份证明号码：</strong>330724199204175432
            </td>
        </tr>
        <tr align="left">
            <td height="42" colspan="2" align="left" class="NNText">
                <strong>报考类别：</strong>传统医学师承出师考核笔试
            </td>
        </tr>
        <tr align="left">
            <td height="42" colspan="3" align="center" class="NNText">
                <strong>指导出师单位：</strong>天津中医药大学第二附属医院
            </td>
        </tr>
        <tr align="left">
            <td height="42" colspan="3" align="center" class="NNText">
                <strong>考试日期：</strong>2020年8月23日
            </td>
        </tr>
        <tr align="left">
            <td height="42" colspan="3" align="center" class="NNText">
                <strong>考场：</strong>天津医学高等专科学校 河西区柳林路14号
            </td>
        </tr>
        </tbody>
    </table>
    <table width="692" border="0" align="center" cellpadding="0" cellspacing="0" class="common"
        ...
        <tbody>
        <tr align="left" class="NText">
            <td width="344" height="42" align="center" class="NNText" style="border-top:none">
                <strong>考室号：</strong>第15考室
            </td>
            <td width="345" align="center" class="NNText" style="border-top:none">
                <strong>座位号：</strong>51
            </td>
        </tr>
        <tr align="left" class="NText">
            <td height="42" colspan="2" align="center" class="NText" style="border-bottom:none;">
                <table width="678" border="0" align="center" cellpadding="0" cellspacing="0" style="border:none">
                    <tbody>
                    <tr>
                        <td height="55" class="NText" style="font-size:22px;border:none">考 场 须
                            知
                        </td>
                    </tr>
                    <tr>
                        <td height="360" valign="top"
                            style="border:none;font-size:16px;line-height:24px;text-align:left">
                            1.考前30分钟考生进入考场，须出示准考证、本人有效身份证明、天津健康码；扫描“津门战疫”二维码；提交《2020年传统医学师承出师考核考生安全考试承诺书》。
                            <br/>2.考生入场除携带必要的文具（2B铅笔、黑色签字笔、橡皮、铅笔刀）外，还须携带医用外科口罩，禁止携带任何其他物品；答题卡填涂区须使用2B铅笔填涂；不得将试卷、答题卡带出场外。
                            <br/>3.统一开考信号发出后，才能开始答题。
                            <br/>4.开考30分钟后，考生不得进入考场；考试开始60分钟内，考生不得交卷退场。
                            <br/>5.考试结束信号发出后，考生应立即停止答题，将试卷和答题卡放在课桌上，监考员收回试卷和答题卡后，在考生准考证上签字确认，对于考生准考证无监考员签字的，如发生答题卡丢失造成考生没有成绩的，后果由考生承担。
                            <br/>6.对违规考生将依据新修订的《医师资格考试违纪违规处理规定》相应条款进行处理。
                            <br/>
                            <br/>
                            <b>提示：</b>考生进入考场后，须在《签到表》上签字，对号入座后将本人《准考证》、《有效身份证明》放在课桌右上角，以便核验。
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
        <tbody>
        <tr align="left" class="NText">
            <td width="300" height="43" align="center" class="NText">
                <strong>考试时间</strong></td>
            <td width="388" align="center" class="NText">
                <strong>科目</strong></td>
        </tr>
        <tr align="left" class="NText">
            <td height="42" align="center" class="NText">上午 09:00-11:30</td>
            <td align="center" class="NText">中医基础知识</td>
        </tr>
        <tr align="left" class="NText">
            <td height="42" align="center" class="NText">下午 14:00-16:30</td>
            <td align="center" class="NText">中医临床专业知识</td>
        </tr>
        </tbody>
    </table>
    <table width="685" border="0" align="center" cellpadding="0" cellspacing="0" class="common" style="border:none">
        <tbody>
        <tr>
            <td height="50" align="right" class="FText" style="border:none;text-align:right;">天津市医学考试中心制</td>
        </tr>
        </tbody>
    </table>
</div>
