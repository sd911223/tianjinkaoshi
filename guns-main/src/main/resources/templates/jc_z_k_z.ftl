...
<!-- saved from url=(0063)http://www.tjwsrc.com/Basic_ECC_form.asp?Pno=130430198209221521 -->
<html xmlns="http://www.w3.org/1999/xhtml">

<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></meta>
    <title>基层卫生专业高级资格考试 - 天津市医学考试中心</title>
...
<object id="factory" viewastext="" style="display:none" classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814"
        codebase="http://www.tjwsrc.com/smsx.cab#Version=7,1,0,60"></object>
...
<div class="noprint">
    <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" class="common" style="border:none">
        <form id="form1" name="form1" method="post" action="http://www.tjwsrc.com/mypageEnt.aspx"
              target="_blank"></form>
        <tbody>
        <tr>
            <td height="60" align="center" valign="middle" style="border:none">
                <a class="layui-btn" href="http://127.0.0.1:8080/Basic_ECC_down.asp?pno=130430198209221521">下载准考证</a>
                <a class="layui-btn" href="http://www.tjwsrc.com/Basic_ECC_form.asp?Pno=130430198209221521#"
                   onclick="javascript:doPrint()">打印准考证</a></td>
        </tr>
        </tbody>
    </table>
</div>
...
<table width="1020" border="0" align="center" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
        <td height="14" colspan="2" align="center" class="NText">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:none;">
                <tbody>
                <tr>
                    <td height="60" align="center" class="ExamTitle" style="border:none;font-size:22px;">
                        2021年基层卫生专业高级资格考试
                    </td>
                </tr>
                <tr>
                    <td height="45" align="center" valign="top" class="FormTitle"
                        style="border:none;font-size:32px; line-height:45px;">准 考 证
                    </td>
                </tr>
                </tbody>
            </table>
        </td>
        <td width="500" rowspan="5" align="center" valign="top" class="nText">
            <table width="98%" border="0" cellspacing="0" cellpadding="0" style="border:none;">
                <tbody>
                <tr>
                    <td height="60" align="center" valign="middle" class="ExamTitle" style="border:none; padding:5px;">
                        <strong>考 生 须 知</strong></td>
                </tr>
                <tr>
                    <td height="373" align="left" valign="top" class="NText"
                        style="border:none; padding:5px; font-size:14px; line-height:27px;">
                        <p>
                            <span >&nbsp;&nbsp;&nbsp; 1.考生凭准考证和有效身份证进入考场，对号入座，将准考证和身份证放置在课桌左上角备查。考试开始30分钟后，考生不得进入考场参加考试，考试开始60分钟内不得交卷退场。
                        <br/>&nbsp; &nbsp; 2.为做好疫情防疫工作，请考生提前1小时到达考点，
                        <strong>主动接受体温测量，出示天津健康码“绿码”，提交填写好的“安全考试承诺书”（报名网站可下载），并扫考点的“津门战役”码。除在核实个人身份时可短暂摘除口罩外，其他时间均须佩戴医用外科口罩，考生还需自备一次性乳胶手套。</strong></span>
                            <span >&nbsp; &nbsp; 3</span>
                            <span >.考生入场除携带身份证件和准考证，禁止携带书籍、纸张、笔记、涂改用品、报刊以及各种无线通讯工具（如寻呼机、移动电话）、电子记事本等与考试无关的物品。纸笔考试可携带必要的文具（钢笔或圆珠笔、2B铅笔、橡皮），考试开始后考生不得相互借用文具。</span>
                            <br/><span >&nbsp; &nbsp; 4.纸笔考试考生须严格按照答题卡填涂要求准确清楚地填涂信息及做答，禁止使用涂改用品，漏填、错填或字迹不清或无法辨认的答题卡视为无效。</span>
                            <br/><span >&nbsp; &nbsp; 5.考生必须严格遵守考场纪律，保持考场安静。考场内禁止吸烟，严禁交头接耳、左顾右盼，严禁偷看、抄袭他人试题答案或交换试卷，严禁冒名替考。</span>
                            <br/><span >&nbsp; &nbsp; 6.在考试结束信号发出后，考生应当立即停止答题，并依照监考员指令离开考场。考生不得将试卷、答题卡以及草稿纸等与考试有关的相关材料带出考场。考生提前交卷，不得在考场及附近逗留、谈论。</span>
                            <br/><span>&nbsp; &nbsp; 7.考生应自觉服从监考人员的管理，不得以任何理由防碍监考人员进行正常工作。对违反《考场规则》、不服从监考人员管理的考生，监考人员将依据《专业技术人员资格考试违纪违规行为处理规定》进行处理。</span>
                            <br/><span >&nbsp; &nbsp; 8.成绩查询网址：天津卫生人才网（</span>
                            <a style="font: 16px/normal sans-serif; text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; white-space: normal; widows: 1; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;"
                               href="http://www.tjwsrc.com.cn/">www.tjwsrc.com.cn</a>
                            <span style="font: 16px/normal sans-serif; color: rgb(0, 0, 0); text-transform: none; text-indent: 0px; letter-spacing: normal; word-spacing: 0px; float: none; display: inline !important; widows: 1; font-size-adjust: none; font-stretch: normal; -webkit-text-stroke-width: 0px;">） 。</span>
                        </p>
                    </td>
                </tr>
                </tbody>
    ...
    <tr>
        <td width="449" height="35" align="center" class="FormTitlex">
            <strong>考生基本信息</strong></td>
        <td width="127" rowspan="2" align="center" class="nText">
            <img src="jc/files/HY_2020082709262471554.jpg" width="112" height="146" style="padding:2px;"></img></td>
    </tr>
    <tr>
        <td align="left" class="nText">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:none;padding-left:3px;">
                <tbody>
                <tr>
                    <td width="64%" height="45" class="btext" style="border:none;">
                        <strong>姓 名:</strong>马翠平
                    </td>
                    <td width="36%" class="btext" style="border:none;">
                        <strong>报考序号:</strong>13411
                    </td>
                </tr>
                <tr>
                    <td height="45" class="btext" style="border:none;">
                        <strong>身份证号:</strong>130430198209221521
                    </td>
                    <td class="btext" style="border:none;">
                        <strong>学 历:</strong>本科
                    </td>
                </tr>
                <tr>
                    <td height="45" class="btext" style="border:none;">
    ...
    <tr>
        <td height="60" colspan="2" align="center" valign="middle" class="FormTitle">
            <strong>专业实践能力科目考场信息</strong></td>
    </tr>
    <tr>
        <td height="28" colspan="2" align="left" valign="top" class="nText">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:none; padding-left:3px;">
                <tbody>
                <tr>
                    <td height="50" colspan="2" class="btext" style="border:none;">
                        <strong>准考证号:</strong>2091330475
                    </td>
                </tr>
                <tr>
                    <td height="50" colspan="2" class="btext" style="border:none;">
                        <strong>考试地点:</strong>天津医学高等专科学校
                    </td>
                </tr>
                <tr>
                    <td height="50" colspan="2" class="btext" style="border:none;">
                        <strong>考试地址:</strong>河西区柳林路14号
                    </td>
                </tr>
                <tr>
                    <td width="49%" height="50" class="btext" style="border:none;">
                    <span class="btext" style="border:none;">
                      <strong>考场号:</strong>机考6考场</span></td>
                    <td width="51%" height="50" class="btext" style="border:none;">
                    <span class="btext" style="border:none;">
                      <strong>座位号:</strong>41</span></td>
                </tr>
                <tr>
                    <td height="50" colspan="2" class="btext" style="border:none;">
                        <strong>考试时间:</strong>2020年9月13日下午15:30-17:30
                    </td>
                </tr>
                </tbody>
            </table>
