<!-- * @Author: kevin * @Date: 2021-01-12 11:37:02 * @LastEditors: Do not edit * @Description: 成绩单 -->
<!DOCTYPE html>
<html lang="en">
...
<div class="noprint">
    <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" class="common" style="border:none">
        <form id="form1" name="form1" method="post" action="http://www.tjwsrc.com/mypdflength.aspx"
              target="_blank"></form>
        <tbody>
        <tr>
            <td height="30" align="center" valign="middle" style="border:none">
                <a class="layui-btn" href="http://127.0.0.1:8080/master_ECBS_down.asp?pno=J120805126">下载PDF</a>
                <a class="layui-btn" href="http://www.tjwsrc.com/master_ECBS_form.asp?Pno=J120805126#"
...
<!--startprint-->
<div id="div1">
    <table width="930" border="0" align="center" cellpadding="0" cellspacing="0" style="border:none">
        <tbody>
        <tr>
            <td height="150" align="center" class="FormTitle" style="border:none;font-size:32px;">
                2020年传统医学师承出师考核实践技能考试成绩单
            </td>
        </tr>
        </tbody>
    </table>
    <table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
        <tbody>
        <tr>
            <td width="130" height="55" align="center" class="NText">
                <strong>准考证号</strong></td>
            <td width="100" align="center" class="NText">
                <strong>姓名</strong></td>
            <td width="80" align="center" valign="middle" class="NText">
                <strong>类别</strong></td>
            <td width="200" align="center" valign="middle" class="NText">
                <strong>身份证号</strong></td>
            <td width="300" align="center" valign="middle" class="NText">
                <strong>单位名称</strong></td>
            <td width="100" align="center" valign="middle" class="NText">
                <strong>考试结果</strong></td>
        </tr>
        <tr>
            <td height="55" align="center" class="NText">2020070131</td>
            <td align="center" class="NText">林元硕</td>
            <td align="center" valign="middle" class="NText">师承</td>
            <td align="center" valign="middle">
                <span class="NText">J120805126</span></td>
            <td align="center" valign="middle">
                <span class="NText">正达专业推拿馆</span></td>
            <td align="center" valign="middle">
                <span class="NText">缺考</span></td>
        </tr>
        </tbody>
    </table>
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="common" style="border:none">
        <tbody>
        <tr>
            <td>
            <img align="right" valign="bottom" class="FText" style="border:none;text-align:right;font-size:24px;"></img>
                <img src="sc/files/blank.gif" height="30"></img></td>
        </tr>
        <tr>
            <td height="100" align="right" valign="bottom" class="FText"
                style="border:none;text-align:right;font-size:24px;">
                <img src="sc/files/scz.png" width="280" height="153"></img></td>
        </tr>
        </tbody>
    </table>
</div>
