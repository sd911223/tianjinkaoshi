...
<!-- saved from url=(0065)http://www.tjwsrc.com/basic_entry_form.Asp?Pno=130430198209221521 -->
...
<table width="690" border="0" align="center" cellpadding="0" cellspacing="0" style="border:none">
    ...
    <tr>
        <td align="right" class="CText" style="border:none;text-align:right;">
            <strong>报名序号</strong>： 202100003305
        </td>
    </tr>
    </tbody>
</table>
...
<table width="690" border="0" align="center" cellpadding="0" cellspacing="0" class="common">
    ...
    <tr>
        ...
        <td width="107" class="FText" style="text-align:right; border-right:none;font-size:14px;">
            <strong>主管区、</strong></td>
        <td width="142" class="FText" style="text-align:left;font-size:14px;">
            <strong>局审查意见</strong></td>
        <td width="243" class="FText" style="font-size:14px;">
            <strong>主管区人社局审核意见</strong></td>
    </tr>
    <tr>
    ...
    <tr>
        <td height="38" colspan="2" align="center" class="FText" style="font-size:14px;">
            <strong>考点审核意见</strong></td>
        <td colspan="2" class="FText" style="font-size:14px;">
            <strong>委职称办审核意见</strong></td>
    </tr>
    <tr>
        <td height="210" colspan="2" align="center" class="FText"
    ...
    <tr>
        <td height="40" colspan="5" align="left" class="NText"
            style="font-size:12px; line-height:20px; border-bottom:none">&nbsp;&nbsp;备注:此表须申报人员仔细核对后签字确认，一旦确认不得修改。
        </td>
    </tr>
    <tr>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="common" style="border:none">
    <tbody>
    <tr>
        <td align="right" class="NText" style="font-size:12px;border:none">制表信息来自：天津卫生人才网（www.tjwsrc.com) 生成时间：2021/1/12
            13:22:55
        </td>
    </tr>
    </tbody>
