...
<!-- saved from url=(0065)http://www.tjwsrc.com/basic_score_form.Asp?Pno=120113197802230833 -->
...
<script language="javascript" type="text/javascript">function doPrint() {
    ...
    //打印背景色
    //factory.printing.printBackground = true;//是否打印背景图片
    ...
    <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0" class="common" style="border:none">
        ...
        <tr>
            <td height="60" align="center" valign="middle" style="border:none">
                <a class="layui-btn" href="http://127.0.0.1:8080/basic_score_down.asp?pno=120113197802230833">下载成绩单</a>
                    <a class="layui-btn" href="http://www.tjwsrc.com/basic_score_form.Asp?Pno=120113197802230833#"
                       onclick="javascript:doPrint()">在线打印</a></td>
        </tr>
        </tbody>
    </table>
</div>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
        <td height="10" align="right" class="common" style="font-size:12px">
            <img src="jc/files/blank.gif"></img></td>
    </tr>
    </tbody>
</table>
<table width="930" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #000">
    <tbody>
    <tr>
        <td height="610" align="center" valign="middle">
            <table width="920" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000; background:url
            (Images/pbg.gif)">
                <tbody>
                <tr>
                    <td height="600" align="center" valign="bottom">
                        <table width="880" border="0" cellspacing="0" cellpadding="0" style="border:none">
                            <tbody>
                            <tr>
                                <td height="75" align="center" class="ExamTitle"
                                    style="font-size:28px;font-weight:bold; border:none">
                                    2021年基层卫生专业高级资格考试成绩单
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        <table width="880" border="0" cellspacing="0" cellpadding="0" style="border:none">
                            <tbody>
                            <tr>
                                <td width="460" valign="top" class="NNText" style="border:none">
                                    <table width="460" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                        <tr></tr>
                                        <tr>
                                            <td width="498" height="205" align="center" valign="bottom">
                                                <img src="jc/files/HY_2020081716392481538.jpg" width="138" height="175"
                                                     style="padding:2px;"></img></td>
                                        </tr>
                                        <tr>
                                            <td height="50" align="left" class="NNText"
                                                style="font-size:22px;line-height:45px;">准考证号： 2091330425
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="50" align="left" class="NNText"
                                                style="font-size:22px;line-height:45px;">证件号码：120113197802230833
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="50" align="left" class="NNText"
                                                style="font-size:22px;line-height:45px;">报考级别：副高级
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="50" align="left" class="NNText"
                                                style="font-size:22px;line-height:45px;">报考专业：全科医学
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="50" align="left" class="NNText"
                                                style="font-size:22px;line-height:45px;">工作单位：天津市北辰区果园新村街社区卫生服务中心
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="10" align="left" class="NNText" style="font-size:22px;">
                                                <img src="jc/files/blank.gif"></img></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <td width="375" valign="top" style="border:none">
                                    <table width="420" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                        <tr>
                                            <td height="316" align="left" valign="bottom" class="FormTitle" style="line-height:40px; vertical-align:bottom; text-align:left; text-
                                  indent:40px;font-size:24px;">
                                                <img src="jc/files/blank.gif" width="32"></img>考生
                                                <span style="border-bottom:1px solid #000">杨春来</span>于2020年9月参加基层卫生专业高级资格考试，专业实践能力考试成绩为
                                                <font style="border-bottom:1px solid #000">40</font>分。
                                                <br/>
                                                <img src="jc/files/blank.gif"></img></td>
                                        </tr>
                                        <tr>
                                            <td height="20" align="left" class="FormTitle"
                                                style="text-indent:40px;line-height:10px; ">
                                                <img src="jc/files/blank.gif"></img></td>
                                        </tr>
                                        <tr>
                                            <td align="left" class="FormTitle" style="text-align:right">
                                                <img src="jc/files/20200913.png" width="280" height="153"></img></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </td>
...
<table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
        <td height="40" align="right" class="common" style="font-size:12px">打印时间：2021/1/12 13:41:27</td>
    </tr>
    </tbody>
</table>
<!--endprint-->
